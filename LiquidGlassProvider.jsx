...
export function LiquidGlassProvider({children}){
    useInsertionEffect(() => {
        let css = `.liquidGlass,.liquidGlass::after,.liquidGlass::before{transform:translate3d(0,0,0);border-radius:.9rem}.liquidGlass,.liquidGlassLarge{position:relative;z-index:1;width:fit-content;color:#fff;font-size:1.1em;text-shadow:0 0 4px #000}.liquidGlass::after,.liquidGlass::before,.liquidGlassLarge::after,.liquidGlassLarge::before{pointer-events:none;position:absolute;top:0;left:0;height:100%;width:100%}.liquidGlass::after{content:"";display:block;z-index:-1;box-shadow:inset 1px 1px 2px 0 rgb(255 255 255 / 87%),inset -1px -2px 3px 1px rgb(49 49 49 / 30%),0 0 6px 1px rgb(0 0 0 / 38%);background:rgb(255 255 255 / 3%)}.liquidGlass::before,.liquidGlassLarge::before{z-index:-2;content:"";display:block;backdrop-filter:blur(3px)}.liquidGlass::before{filter:url(#liquidGlassFilter2)}.glassLightMode{color:#000;font-size:1em;text-shadow:none}.glassLightMode::after{box-shadow:1px 2px 4px -2px rgb(0 0 0 / 27%),inset 2px 3px 5px 0 rgb(255 255 255 / 28%);background-color:#00000009}.liquidGlassLarge,.liquidGlassLarge::after,.liquidGlassLarge::before{transform:translate3d(0,0,0);border-radius:3rem}.liquidGlassLarge::before{filter:url(#liquidGlassFilter)}.liquidGlassLarge::after{content:"";display:block;z-index:-1;background:rgb(255 255 255 / 3%);box-shadow:inset 1px 1px 3px 1px rgb(255 255 255 / 38%),inset -1px -2px 3px 1px rgb(49 49 49 / 30%),0 0 7px 1px rgb(0 0 0 / 46%)}button.liquidGlass,button.liquidGlassLarge{appearance:none;-webkit-appearance:none;background:0 0;border:0;font-family:inherit;cursor:pointer}.liquidBtn{background:#ffffff36;border:1px solid #ffffff78;backdrop-filter:blur(3px);color:#fff;text-shadow:0 0 7px #000;padding:.5rem;font-size:1.1rem;border-radius:.5rem;transition:150ms}.liquidBtn:hover{background:#ffffff59}.dynamic::after{background:var(--background)!important;box-shadow:var(--shadow)!important}.dynamic:hover::after{background:var(--backgroundHover)!important}.blur-0::before{backdrop-filter:blur(0px)}.blur-1::before{backdrop-filter:blur(1px)}.blur-2::before{backdrop-filter:blur(2px)}.blur-3::before{backdrop-filter:blur(3px)}.blur-4::before{backdrop-filter:blur(4px)}.blur-5::before{backdrop-filter:blur(5px)}.blur-6::before{backdrop-filter:blur(6px)}.blur-7::before{backdrop-filter:blur(7px)}.blur-8::before{backdrop-filter:blur(8px)}.blur-9::before{backdrop-filter:blur(9px)}.blur-10::before{backdrop-filter:blur(10px)}`
        ...
        <defs>
            ...
            <filter id="liquidGlassFilter2" color-interpolation-filters="linearRGB" filterUnits="objectBoundingBox" primitiveUnits="userSpaceOnUse">
                ...
                <feTurbulence type="fractalNoise" baseFrequency="0.019 0.008" numOctaves="5" seed="8" stitchTiles="stitch" x="0%" y="0%" width="100%" height="100%" result="turbulence"/>
                <feDisplacementMap in="blend" in2="turbulence" scale="6" xChannelSelector="R" yChannelSelector="B" x="0%" y="0%" width="100%" height="100%" result="displacementMap1"/>
            </filter>
        </defs>`;
